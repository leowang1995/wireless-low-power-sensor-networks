...
/*
 * ARPA-E Project wireless communication device code for programming.
 *
...
//#define GAS_INT PA11  //PA11 is used for G2 gas interrupt input
...
void NodeLoop()
{
  while (1)
  {
    //Serial.println("SensorNode is asleep");
    Sleep();
    //delay(10000);
    ...
    if (hexanalDetected)
    {
      ...
      //Serial.println("SensorNode is awake");
      //delay(10000);
...
// When the gas pin goes high (RISING EDGE), it will wake up,
